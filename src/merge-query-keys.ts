...
import { omitPrototype, type Add } from './internals';

type StoreFromMergedQueryKeys<
  QueryOrMutationKeyFactoryResults extends Array<
    AnyQueryKeyFactoryResult | AnyMutationKeyFactoryResult
  >,
